...
describe('<App /> standard render tests', () => {
	...
	it('Tests that App renders without crashing', () => {
		// App now exports as so: export default connect(App.mapStateToProps)(App);
		// So we need to mount it with the connect() function
...
describe('<App /> mapStateToProps', () => {
	...
	it(`Verifies that the function returns the right object when passing fromJS({ isUserLoggedIn: true })`, () => {
